...
export const SCHOOL_YEAR_REPOSITORY = Symbol('SchoolYearRepository');

export const SCHOOL_YEAR_SERVICE = Symbol('SchoolYearService');

export const SCHOOL_YEAR_CREATE_USE_CASE = Symbol('SchoolYearCreateUseCase');
