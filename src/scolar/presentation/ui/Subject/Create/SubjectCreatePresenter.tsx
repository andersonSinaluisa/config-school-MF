...
import { CreateSubjectCommand } from "@/scolar/application/useCases/subjects/createSubjectUseCase"
import { AlertCircle, Check, ChevronRight, HelpCircle, Home, Info, Save, ShieldCheck } from "lucide-react"
import { FieldErrors, UseFormRegister } from "react-hook-form"
import { Link } from "react-router-dom"

interface SubjectCreatePresenterProps {
    onSubmit: () => Promise<void>
    onCancel: () => void
    register: UseFormRegister<CreateSubjectCommand>
    errors: FieldErrors<CreateSubjectCommand>
    isSubmitting: boolean
    formData: CreateSubjectCommand
}

export const SubjectCreatePresenter = ({
    onSubmit,
    onCancel,
    register,
    errors,
                        ...
                        <form onSubmit={onSubmit}>
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="code" 
                                        {...register("data.code", { required: true })}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        min="1"
                                        max="40"
                                        {...register("data.hoursPerWeek", { required: true })}
