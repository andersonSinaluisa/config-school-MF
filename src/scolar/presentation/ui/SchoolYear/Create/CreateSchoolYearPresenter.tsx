...
import { CreateSchoolYearUseCaseCommand } from "@/scolar/application/useCases/schoolYears/createSchoolYearUseCase"
...
interface CreateSchoolYearPresenterProps {
    ...
    onCancel: () => void
    register: UseFormRegister<CreateSchoolYearUseCaseCommand>
    errors: FieldErrors<CreateSchoolYearUseCaseCommand>
    isSubmitting: boolean
    formData: CreateSchoolYearUseCaseCommand
    control: Control<CreateSchoolYearUseCaseCommand, CreateSchoolYearUseCaseCommand>
}

export const CreateSchoolYearPresenter = ({
    isSubmitting,
    onCancel,
    onSubmit,
    register,
    ...
    return (
        <form className="space-y-6" onSubmit={onSubmit}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>{"Crear"} Año Escolar</CardTitle>
                    </CardHeader>
