...
import { UpdateCourseCommand } from "@/scolar/application/useCases/courses/updateCourseUseCase"
...
interface CourseEditPresenterProps {
    onBack: () => void
    isSubmitting: boolean
    handleSubmit: (e: React.FormEvent) => void;
    formData: UpdateCourseCommand;
    levels: Level[]
    register: UseFormRegister<UpdateCourseCommand>
    control: Control<UpdateCourseCommand, UpdateCourseCommand>
}
export const CourseEditPresenter = ({
    onBack,
    isSubmitting,
    handleSubmit,
    formData,
                    ...
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription>
                                ...
                                para editar el curso. Asegúrate de que toda la información sea correcta antes de guardar.
