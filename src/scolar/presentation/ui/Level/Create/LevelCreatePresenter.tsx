...
interface LevelCreatePresenterProps {
    onSubmit: () => void
    onCancel: () => void
    register: UseFormRegister<CreateLevelCommand>
    errors: FieldErrors<CreateLevelCommand>
    isSubmitting: boolean
    formData: CreateLevelCommand
}


export const LevelCreatePresenter = ({ register, onSubmit, onCancel, errors, isSubmitting, formData }: LevelCreatePresenterProps) => {
